...
var filmes = [
    ...
    { titulo: 'Interestelar', imagem: 'img/Interestelar.jpg' },
    { titulo: 'Guardiões da Galáxia Vol. 3', imagem: 'img/Guardiões da Galáxia Vol. 3.jpg' },
    { titulo: 'Túmulo dos Vagalumes', imagem: 'img/Tumulo dos Vagalumes.jpg' },
    { titulo: 'Até o Último Homem', imagem: 'img/Até o Último Homem.jpg' },
    ...
    { titulo: 'Duna', imagem: 'img/Duna.jpg' },
    { titulo: 'Camaleões', imagem: 'img/Camaleões.jpg' },
    { titulo: 'Wonka', imagem: 'img/Wonka.jpg' },
    { titulo: 'Moonfall', imagem: 'img/Moonfall.jpg' },
    { titulo: 'A Guerra do Amanhã', imagem: 'img/A Guerra do Amanhã.jpg' },
    { titulo: 'A Sociedade da Neve', imagem: 'img/A Sociedade da neve.jpg' },
    { titulo: 'O Vendedor de Passados', imagem: 'img/O Vendedor de Passados.jpg' },
    { titulo: 'Wall-E', imagem: 'img/Wall-E.jpg' }
